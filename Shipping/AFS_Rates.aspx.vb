...
Public Partial Class LTLRateSample
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        ...
        strSQL = "EXEC AFS_WebServiceParam_2 @OrderID"
        ...
        If Not IsPostBack Then
			...
			trace.warn("http://10.5.9.57/apps/order/reserve_afs.asp?" + Request.QueryString.toString() + "")

            If Request.UrlReferrer Is Nothing Then
				strPageReferrerUrl = "http://10.5.9.57/apps/order/reserve_afs.asp?" + Request.QueryString.toString() + ""
            Else

<%@ Page Title="" Language="VB" Trace="false" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="AFS_FreightBills_Sandbox.aspx.vb" Inherits="AFS_FrieghtBills_Sandbox" %>
...
<!-- TEST CODE LSHTEMP -->
   ...
   <asp:TableRow>
    ...
    <asp:Button ID="btn_Upload" runat="server" Text="Upload" OnClientClick="this.disabled=true;" UseSubmitBehavior="false" OnClick="btn_Upload_Click" />
    <br />
...
<%--       
    Laurie field buttonSAVING FOR LATER

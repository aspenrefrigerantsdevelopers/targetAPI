...
Public Partial Class LTLRateSample
    ...
    Sub gv_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim strDistance As Integer
        Dim strAccessorial As String
        Dim strFreightCost As String
        Dim strFuelSurcharge As String
        Dim intServiceDays As Integer
        Dim strServiceType As String
        Dim strShipmentMethod As String
        Dim strTrueCost As String
        ...
        Trace.Warn("you selected " + gvrow.Cells(0).Text + " - (0)")
        Trace.Warn("you selected " + gvrow.Cells(1).Text + " - (1)")
        Trace.Warn("you selected " + gvrow.Cells(2).Text + " - (2)")
        Trace.Warn("you selected " + gvrow.Cells(3).Text + " - (3)")
        Trace.Warn("You selected " + gvrow.Cells(4).Text + " - (4)")
        Trace.Warn("you selected " + gvrow.Cells(5).Text + " - (5)")
        Trace.Warn("you selected " + gvrow.Cells(6).Text + " - (6)")
        Trace.Warn("you selected " + gvrow.Cells(7).Text + " - (7)")
        Trace.Warn("you selected " + gvrow.Cells(8).Text + " - (8)")
        Trace.Warn("you selected " + gvrow.Cells(9).Text + " - (9)")
        Trace.Warn("you selected " + gvrow.Cells(10).Text + " - (10)")
        Trace.Warn("you selected " + gvrow.Cells(11).Text + " - (11)")
        Trace.Warn("you selected " + gvrow.Cells(12).Text + " - (12)")
        Trace.Warn("you selected " + gvrow.Cells(13).Text + " - (13)")
        ...
        cmd.Parameters.AddWithValue("@Distance", CType(gvrow.Cells(6).Text, Integer))
        cmd.Parameters.AddWithValue("@AccessorialCosts", CType(gvrow.Cells(9).Text, Decimal))
        cmd.Parameters.AddWithValue("@EstimateCost", CType(gvrow.Cells(10).Text, Decimal))
        cmd.Parameters.AddWithValue("@FreightCost", CType(gvrow.Cells(7).Text, Decimal))
        cmd.Parameters.AddWithValue("@FuelSurcharge", CType(gvrow.Cells(8).Text, Decimal))
        cmd.Parameters.AddWithValue("@ServiceDays", CType(gvrow.Cells(4).Text, Integer))
        cmd.Parameters.AddWithValue("@ServiceType", gvrow.Cells(12).Text)
        cmd.Parameters.AddWithValue("@ShipmentDate", Convert.ToDateTime(tShipDateAdv.Text))
        cmd.Parameters.AddWithValue("@ShipmentMethod", CType(gvrow.Cells(13).Text, Integer))
        cmd.Parameters.AddWithValue("@TrueCost", CType(gvrow.Cells(11).Text, Decimal))
        cmd.Parameters.AddWithValue("@CarrierChoice", 1)
        cmd.Parameters.AddWithValue("@CarrierPhone", DBNull.Value)
        cmd.Parameters.AddWithValue("@DeliveryDate", Convert.ToDateTime(gvrow.Cells(5).Text))

...
Partial Public Class AFS_FrieghtBills
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If Not isPostback Or ddl_Invoices.Selectedvalue = "" Then
            ...
            strSQL.Append("SELECT AFS_Invoice FROM Freight_AFS_Bills GROUP BY AFS_Invoice")
        ...
        lbl_Total_Count.Text = Convert.ToString(Convert.ToInt32(lbl_NoOrderNumber_Count.Text) + Convert.ToInt32(lbl_FreightCharge_Count.Text) + Convert.ToInt32(lbl_NotToBePaid_Count.Text))

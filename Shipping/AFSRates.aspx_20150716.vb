...
Public Partial Class LTLRateSample
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If Not IsPostBack Then
			...
			Trace.Warn("http://10.5.9.40/apps/order/reserve_afs.asp?" + Request.QueryString.ToString() + "")

            If Request.UrlReferrer Is Nothing Then
				strPageReferrerUrl = "http://10.5.9.40/apps/order/reserve_afs.asp?" + Request.QueryString.ToString() + ""
            Else
